...
public class CharResourceLoader implements IResourceManagerReloadListener
{
    ...
    private CharResourceLoader(IResourceManager resMan)
    {
        this.res = resMan;
    }
    
    public static final CharResourceLoader INSTANCE = new CharResourceLoader(Minecraft.getMinecraft().getResourceManager());
    public static CharResourceLoader getInstance() {return INSTANCE;}
    ...
    public boolean loadRes(ResourceLocation location, String res)
    {
        ...
        catch (IOException ioexception)
        {
            ...
            res = CharResourceLoader.MISSING_RES;
    ...
    public void onResourceManagerReload(IResourceManager res)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (s.equals(CharResourceLoader.MISSING_RES))
            {
                iterator.remove();
            }
            else
