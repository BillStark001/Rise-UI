...
public class RenderHUD {
	...
	public static void doRender(double delta){
        ...
        //prepareColor(1,t);
        r.setNormal(0,0,1);
        r.addVertexWithUV(-WIDTH, -LENGTH, SECOND, 0.0, 0.0); //左上
        r.addVertexWithUV(WIDTH, -LENGTH, SECOND, 1, 0); //左下
        r.addVertexWithUV(WIDTH, LENGTH, SECOND, 1.0, 1.0); //右下
        r.addVertexWithUV(-WIDTH, LENGTH, SECOND, 0, 1); //右上
        t.draw(); 
        GL11.glPopMatrix();
        */
